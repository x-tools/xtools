...
class GlobalContribsController extends XtoolsController
{
    ...
    #[Route(
        "/ec-latestglobaledits/{username}/{namespace}/{start}/{end}/{offset}",
        name: "EditCounterLatestGlobalEdits",
        requirements: [
            "username" => "(ipr-.+\/\d+[^\/])|([^\/]+)",
        ],
        defaults: [
    ...
    #[Route(
        "/ec-latestglobal-contributions/{username}/{namespace}/{start}/{end}/{offset}",
