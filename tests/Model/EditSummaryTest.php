...
class EditSummaryTest extends TestAdapter {
	...
	public function testGetters(): void {
		...
		static::assertSame( 1, $this->editSummary->getRecentEditsMinor() );
		static::assertSame( 1, $this->editSummary->getRecentEditsMajor() );

		static::assertEquals( 2, $this->editSummary->getTotalSummaries() );
		static::assertSame( 1, $this->editSummary->getTotalSummariesMinor() );
		static::assertSame( 1, $this->editSummary->getTotalSummariesMajor() );

		static::assertSame( 0, $this->editSummary->getRecentSummariesMinor() );
		static::assertSame( 1, $this->editSummary->getRecentSummariesMajor() );
