...
class PagesTest extends TestAdapter
{
    ...
    public function testResults(): void
    {
        ...
        static::assertEquals(null, $pages->getLastTimestamp());
        ...
        static::assertEquals(false, $pages->resultsPerPage(true));
        static::assertEquals([
    ...
    public function testSingleNamespace(): void
    {
        ...
        static::assertEquals(1, $pages->getNumPages());
        $counts = $pages->getCounts();
        static::assertEquals(1, $counts[104]['prp_quality3']);
    }
